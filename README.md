...
11. To run the website serverless, first create an S3 bucket:
    ...
    - Then click Edit for Bucket policy, and add a policy like this shown below (but with your Bucket ARN, shown on top of edit area, and make sure it ends with /*), and hit Save changes:
